 ...
 */
public final class HealthPlanGenericImpl implements HealthPlan {
 ...
 public HealthPlanGenericImpl() {
    	
        this("default", Collections.emptyList(), "all-state");
        
    }
 
 
    public HealthPlanGenericImpl(String name, String state) {
    	
        this(name, Collections.emptyList(), state);
        
    }

    public HealthPlanGenericImpl(String name, List<HealthBenefit> benefits, String state) {
    ...
    public HealthPlanGenericImpl copy() {
    	
        List<HealthBenefit> benefits = getBenefits()
        									.map(HealthBenefit::copy)
        									.collect(toList());
        
        return new HealthPlanGenericImpl(name, benefits, state);
    }
