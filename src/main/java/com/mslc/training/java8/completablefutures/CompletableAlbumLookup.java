...
// END lookupByName
	...
	public static void main(String[] args) {
		...
		CompletableAlbumLookup al = new CompletableAlbumLookup(new ArrayList(), new ArrayList());

		long start = System.currentTimeMillis();
		Album a = al.lookupByName("Some Album");
		long end = System.currentTimeMillis();
		System.out.println("Got in : " + (end - start) + " " + a);
		SERVICE.shutdown();
