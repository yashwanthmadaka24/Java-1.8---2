...
public class Ch9App3BroadCastingClient {
	private DatagramSocket socket;
	private InetAddress address;
	private int expectedServerCount;
	private byte[] buf;

	public Ch9App3BroadCastingClient(int expectedServerCount) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		Ch9App3BroadCastingClient client = new Ch9App3BroadCastingClient(1);
		while (true) {

			client.discoverServers("My Message : " + new Date());
			Thread.sleep(1000);
		}
